...
#define MyAppName "KodiLauncher"
#define MyAppVersion "1.0.0.0"
#define MyAppPublisher "baijuxavior@gmail.com"
#define MyAppExeName "KodiLauncher.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{F4A80E18-9F0A-4743-8253-D4E5135E75BD}
AppName={#MyAppName}
AppVersion={#MyAppVersion}
VersionInfoProductVersion=1.0.0.0
VersionInfoVersion=1.0.0.0
AppPublisher={#MyAppPublisher}
AppMutex=kodi_launcher_mutex
DefaultDirName={pf32}\KodiLauncher
DefaultGroupName=KodiLauncher
OutputBaseFilename=KodiLauncher V1.0.0.0
Compression=lzma
...
var
 ...
 begin
  ...
  if ( sPrevVersion = '1.0.0.0' ) then
    if MsgBox ('KodiLauncher V1.0.0.0 is already installed. Do you want to install it again?', mbInformation, MB_yesno) = idyes then
        Result:= true

  if ( sPrevVersion > '1.0.0.0' ) then
        if MsgBox ('A higher version KodiLauncher V' + sPrevVersion + ' is already installed. Press Yes to uninstall it or No to exit the setup.', mbInformation, MB_yesno) = idno then
        Result:= false
       else
          begin 
...
[Components]
Name: "OptionMainApps"; Description: "KodiLauncher";   Types: full compact custom ; Flags: fixed
Name: "OptionShell"; Description: "Set KodiLauncher as Windows Shell";   Types: custom 
...
Source: "Script Files\KodiLauncher.exe"; DestDir: {app}; Flags: ignoreversion     ; Components: OptionMainApps
Source: "Script Files\KodiLauncher.ico"; DestDir: {app}; Flags: ignoreversion     ; Components: OptionMainApps

Source: "XBMCLauncherGUI\XBMCLauncherGUI\bin\Release\KodiLauncherGUI.exe"; DestDir: {app}; Flags: ignoreversion     ; Components: OptionMainApps
...
Source: "Script Files\CustomMCERegistry.reg"; DestDir: {userappdata}\KodiLauncher; Flags: ignoreversion ; Components: OptionMCERegistry
Source: "Script Files\OriginalMCERegistry.reg"; DestDir: {userappdata}\KodiLauncher; Flags: ignoreversion ; Components: OptionMCERegistry
Source: "Script Files\PinToTaskbar.exe"; DestDir: {app}\; Flags: ignoreversion ; MinVersion: 6.1

[Registry]
Root: HKCU; Subkey: Software\Microsoft\Windows NT\CurrentVersion\Winlogon; ValueType: string; ValueName: Shell; ValueData: {app}\KodiLauncher.exe; Flags: noerror; Components: OptionShell
Root: HKCU; Subkey: Software\KodiLauncher; Flags: uninsdeletekey;
Root: HKCU; Subkey: Software\KodiLauncher; ValueType: string; ValueName: Kodi_Path; ValueData: {pf32}\Kodi\Kodi.exe; Flags: noerror createvalueifdoesntexist;
Root: HKCU; Subkey: Software\KodiLauncher; ValueType: string; ValueName: iMON_Path; ValueData: {pf32}\SoundGraph\iMON\iMON.exe; Flags: noerror createvalueifdoesntexist;

Root: HKCU; Subkey: Software\KodiLauncher; ValueType: string; ValueName: ShowCustomShutdownMenu; ValueData: 1; Flags: noerror; Components: OptionShutdownMenu
Root: HKCU; Subkey: Software\KodiLauncher; ValueType: string; ValueName: ShutdownAction; ValueData: u; Flags: noerror; Components: OptionShutdownMenu
...
[Icons] 
Name: "{userstartup}\KodiLauncher"; Filename: {app}\KodiLauncher.exe
Name: {group}\KodiLauncher; Filename: {app}\KodiLauncher.exe ;HotKey: "ctrl+alt+F10"
Name: {group}\KodiLauncherGUI; Filename: {app}\KodiLauncherGUI.exe
Name: {commondesktop}\KodiLauncher GUI; Filename: {app}\KodiLauncherGUI.exe; Tasks: desktopicon; Comment: "GUI for KodiLauncher Settings"
...
Name: {group}\{cm:UninstallProgram,KodiLauncher}; Filename: {uninstallexe}

[Tasks]
Name: desktopicon; Description: Add KodiLauncherGUI shortcut to Desktop; GroupDescription: {cm:AdditionalIcons}
Name: pintotaskbar; Description: Add KodiLauncherGUI shortcut to Taskbar [Pin to Taskbar] ; GroupDescription: {cm:AdditionalIcons}; MinVersion: 6.1

[Run]

Filename: {win}\regedit.exe; Description: Install Custom MCE Registry; Parameters: /s {userappdata}\KodiLauncher\CustomMCERegistry.reg; Flags: runhidden nowait; Components:Option\CustomMCE 
Filename: {win}\regedit.exe; Description: Install Original MCE Registry; Parameters: /s {userappdata}\KodiLauncher\OriginalMCERegistry.reg; Flags: runhidden nowait; Components:Option\OriginalMCE 
Filename: {app}\PinToTaskbar.exe; Tasks: Pintotaskbar
Filename: {app}\KodiLauncherGUI.exe; Description: Run KodiLauncherGUI; Flags: nowait postinstall skipifsilent; WorkingDir: {app}  
Filename: {app}\KodiLauncher.exe; Description: Run KodiLauncher; Flags: nowait postinstall; WorkingDir: {app}

[UninstallDelete]
Name: {userappdata}\KodiLauncher; Type: dirifempty
